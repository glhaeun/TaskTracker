...
const ApiMockResponse = [
  ...
  const serializedData = JSON.stringify(ApiMockResponse);

localStorage.setItem(LocalStorageKeyName, serializedData);
...
class BoardAPI {
  async fetchBoardList() {
    ...
    return BoardList;
    // TODO: Integrate the API module when you have an API from the backend team
  }
}
...
function updateLocalStorageBoards(boards) {
  localStorage.setItem(LocalStorageKeyName, JSON.stringify(boards));
}

module.exports = { fetchBoardList, updateLocalStorageBoards };

    ...
    <div key={boards.id} style={{ width: '300px' }}>
      <Droppable key={boards.id} droppableId={boards.id}>
        {(provided) => (
          ...
          sx={{ width: '300px', padding: '10px', marginRight: '10px', marginBottom: '10px',backgroundColor:'white',
          borderRadius:'0.5rem', borderTop: `10px solid ${boards.color}`, 
              ...
              onClose={() => {
                ...
                <p onClick={() => 
                  setConfirmDialog({
                    ...
                    onConfirm: ()=> {deleteBoard(boards.id)}
                  })
                  }>Delete</p>
              </Menu>
            )}
                  ...
                  <Draggable key={task._id} draggableId={task._id} index={index}>
                    {(provided, snapshot) => (
                      <MainCard 
                        ...
                        onClick={() => toggleCardInfo(task, boards.id)}
                      ...
                      onClose={() => {
                        ...
                        <p onClick={(e) => {
                          ...
                          setConfirmDialog({
                            ...
                            subtitle: "You can't undo this operation!",
                            onConfirm: ()=> {removeCard(boards.id, task.id)}
                          })
                      ...
                      onClose={() => {
                        ...
                        <p onClick={(e) => {
                          ...
                          setConfirmDialog({
                            ...
                            title: "Are you sure to delete this task?",
                            subtitle: "You can't undo this operation!",
                            onConfirm: ()=> {removeCard(board.id, task.id)}
                          })
